...
arch_names = list(DefRUnet.__dict__.keys())
...
def parse_args():
    ...
    parser.add_argument('--arch', '-a', metavar='ARCH', default='DefRUnet',
                        choices=arch_names,
...
def main():
    ...
    model = DefRUnet.NestedUResnet(block=DefRUnet.BasicBlock, layers=[3, 4, 6, 3], num_classes=3)
